                ...
                <div className="container">
                    ...
                    <div className="grid_3 grid_4">
                        ...
                        <table className="table">
                            ...
                            <tr>
                                <td>
                                <h1 id="h1-bootstrap-heading">h1. Bootstrap heading<a className="anchorjs-link" href="#h1.-bootstrap-heading"><span
                                        className="anchorjs-icon"></span></a></h1>
                                </td>
                                <td className="type-info">Semibold 36px</td>
                            </tr>
                            <tr>
                                <td>
                                <h2 id="h2-bootstrap-heading">h2. Bootstrap heading<a className="anchorjs-link" href="#h2.-bootstrap-heading"><span
                                        className="anchorjs-icon"></span></a></h2>
                                </td>
                                <td className="type-info">Semibold 30px</td>
                            </tr>
                            <tr>
                                <td>
                                <h3 id="h3-bootstrap-heading">h3. Bootstrap heading<a className="anchorjs-link" href="#h3.-bootstrap-heading"><span
                            ...
                            <tr>
                                <td>
                                <h4 id="h4.-bootstrap-heading">h4. Bootstrap heading<a className="anchorjs-link" href="#h4.-bootstrap-heading"><span
                                        className="anchorjs-icon"></span></a></h4>
                                </td>
                                <td className="type-info">Semibold 18px</td>
                            </tr>
                            <tr>
                                <td>
                                <h5 id="h5-bootstrap-heading">h5. Bootstrap heading<a className="anchorjs-link" href="#h5.-bootstrap-heading"><span
                                        className="anchorjs-icon"></span></a></h5>
                                </td>
                    ...
                    <p className="grid1 ">
                        <button type="button" className="btn btn-1 btn-default">Default</button>
                        <button type="button" className="btn btn-1 btn-primary">Primary</button>
                        <button type="button" className="btn btn-1 btn-success">Success</button>
                        <button type="button" className="btn btn-1 btn-info">Info</button>
                        <button type="button" className="btn btn-1 btn-warning">Warning</button>
                        <button type="button" className="btn btn-1 btn-danger">Danger</button>
                        <button type="button" className="btn btn-1 btn-link">Link</button>
                    </p>
                    <p className="grid1">
                    ...
                    <div className="progress">
                        <div className="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"><span
                    ...
                    <div className="progress">
                        ...
                        aria-valuemax="100" style="width: 40%"><span className="sr-only">40% Complete (success)</span></div>
                    </div>
                    <div className="progress">
                    ...
                    <div className="progress">
                        ...
                        aria-valuemax="100" style="width: 60%"><span className="sr-only">60% Complete (warning)</span></div>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0"
                        aria-valuemax="100" style="width: 80%"><span className="sr-only">80% Complete (danger)</span></div>
                    </div>
                    <div className="progress">
                    ...
                    <div className="bs-example" data-example-id="contextual-table" style="border: 1px solid #eee">
                        <table className="table">
                        <thead>
                            <tr>
                            <th>#</th>
                    ...
                    <div className="bs-example" data-example-id="simple-horizontal-form">
